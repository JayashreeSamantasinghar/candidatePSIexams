package com.psiexams.extentReport;
...
public class CreateAccount2 extends TestNGReusables {//OR extends from testng reusables for extent report
...
public void clickOnCreateAccount() throws InterruptedException {
	...
	test.log(LogStatus.PASS, "account link is opened");
}
...
public void createTheAccount() throws InterruptedException {
	...
	test.log(LogStatus.PASS, "emailId is created");
...
public void logout() {
	...
	test.log(LogStatus.PASS, "log out from account");
}
